      ...
      {isModalOpen && (
        <PostModal
          post={{
            ...
            content: `“부트캠프 동기들과 책 스터디를 했는데 최종 면접에서 저희가 읽은 책에 관심을 가져주셨어요. 오프라인 부트캠프 정말 좋았어요. 사람은 사람을 만나야 한다는 생각이 들어요💓“백엔드 개발 부트캠프를 수료하고 풀스택 개발자로 취업한 채림님의 풀 스토리를 확인해보세요! 채림님 취업 스토리 확인하기 👉🏻 프로필 링크 클릭`,
            comments: [
